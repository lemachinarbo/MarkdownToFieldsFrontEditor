...
export function createToolbarButtons({
  ...
  return [
    ...
    },
    {
      ...
      `,
      action: () => {
        // This will be handled by the image picker integration
        // The actual implementation will be added when integrating with the editors
    ...
    },
    {
      key: "markdown",
      label: `
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-markdown"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10" /><path d="M7 15v-6l2 2l2 -2v6" /><path d="M14 13l2 2l2 -2m-2 2v-6" /></svg>
      `,
      action: () => {
        if (typeof onToggleMarkdownView === "function") {
          onToggleMarkdownView();
        }
      },
      isActive: () =>
        typeof isMarkdownView === "function"
          ? Boolean(isMarkdownView())
          : false,
